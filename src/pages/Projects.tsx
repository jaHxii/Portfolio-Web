...
const Projects = () => {
  ...
  const projects: Project[] = useMemo(
    () => [
      ...
      },
      {
        ...
        metrics: ['Built for enterprise IT support'],
      },
      {
        title: 'Real-Time Analytics Dashboard',
        description:
          'Live data monitoring dashboard with WebSocket streaming, optimized data rendering, and interactive visualizations for operational metrics.',
        category: 'Frontend',
      ...
      },
      {
        ...
        description:
          'Progressive web application with offline capabilities and caching strategies, a responsive product management interface, and performance optimizations.',
        category: 'Full Stack',
        tech: ['PWA', 'Offline Caching', 'Responsive UI'],
      },
      {
        ...
        category: 'IT/DevOps',
        tech: ['Windows', 'Network Scanning', 'IT Asset Management'],
      },
      {
        title: 'Melala Coffee',
        description:
  ...
  return (
    <div className='min-h-screen bg-background'>
      ...
      {/* Hero Section */}
      <section className='pt-24 pb-16 bg-gradient-to-br from-background via-surface/30 to-background'>
...
const ProjectCard = ({
  ...
  return (
    <motion.div
      ...
      className='group'
    >
      <Card className='card-surface border-border/50 hover:border-primary/30 transition-all duration-300 h-full flex flex-col'>
